...
Describe "New-IPSubnet" {
    ...
    Context "Success" {
        It "IPAddressV4" {
            ...
            $Result.TypeName | Should -BeLikeExactly "IPSubnet"
        }
    ...
    Context "Failure" {
        ...
        It "InvalidCastV4" {
            ...
            $Test | Should -Throw "An invalid prefix for the given address family was specified."
        }
...
Describe "IPSubnet Class" {
    ...
    Context "Success" {
        ...
        It "Subnet" {
            ...
            ($Subnets0 = $Result[0].Subnet(24)) | Should -HaveCount 256
            $Subnets0[0].Contains($Result[0].Network) | Should -BeTrue
            $Subnets0[-1].Contains($Result[0].LastAddress) | Should -BeTrue


            ($Subnets1 = $Result[1].Subnet(72)) | Should -HaveCount 256
            $Subnets1[0].Contains($Result[1].Network) | Should -BeTrue
        ...
        It "Supernet" {
            ...
            ($Result0 = $Result[0].Subnet(8)) | Should -HaveCount 1
            $Result0[0].Contains($Result[0].Network) | Should -BeTrue
            $Result0[0].Contains($Result[0].LastAddress) | Should -BeTrue

            ($Result1 = $Result[1].Subnet(56)) | Should -HaveCount 1
            $Result1[0].Contains($Result[1].Network) | Should -BeTrue
