Describe 'New-IPSubnet' {
    Context 'Success' {
        It 'IPAddressV4' {
            $Result = New-IPSubnet -IPAddress '169.254.0.0' -IPPrefix 16

            $Result | Should -BeOfType [System.Net.IPSubnet]
        }

        It 'IPAddressV6' {
            $Result = New-IPSubnet -IPAddress 'fe80::' -IPPrefix 64

            $Result | Should -BeOfType [System.Net.IPSubnet]
        }

        It 'InputObject' {
            $Result = New-IPSubnet -InputObject '169.254.0.0/16', 'fe80::/64'
